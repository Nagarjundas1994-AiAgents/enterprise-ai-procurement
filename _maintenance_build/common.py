...
TITLE = "Autonomous Asset Maintenance &amp; Operations Control Tower — SAP CAP from Zero to Production"
SUBTITLE = "End-to-End CAP + UI5 + MCP + A2A Hands-On Course, Chapters 00-90"
STORAGE_KEY = "sap-assetops-control-tower-v1"
...
<header class="topbar">
  ...
  <a class="brand" href="#top">
    ...
    <span><b>AssetOps Control Tower</b><small>CAP + UI5 + MCP + A2A Course</small></span>
  </a>
