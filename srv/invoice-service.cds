...
// A2A agentification via @cap-js/agents, served at /a2a/invoices
...
// --- Human-in-the-loop for money-moving / state-changing actions ---
annotate InvoiceService.approveInvoice with @agent.hitl;
annotate InvoiceService.createPayment with @agent.hitl;
