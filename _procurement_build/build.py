...
import content_part6
import content_part7
import content_part8

OUT = os.path.join(os.path.dirname(__file__), "..", "Autonomous-Procurement-Control-Tower-Masterclass.html")

NAV = [
    ("Start", [
        ("top", "00", "Welcome &amp; master model"),
        ("roadmap", "&#9679;", "Journey &amp; build status"),
        ("m01", "01", "Business problem"),
        ("m02", "02", "Architect thinking"),
        ("m03", "03", "A2A+MCP architecture map"),
    ]),
    ("Foundation", [
        ("m04", "04", "Setup: Node, CAP, Postgres"),
        ("m05", "05", "CDS domain model"),
        ("m06", "06", "Database: SQLite to HANA"),
        ("m07", "07", "OData V4 service"),
        ("m08", "08", "CRUD + lifecycle"),
        ("m09", "09", "Business logic + tx"),
    ]),
    ("Trust", [
        ("m10", "10", "AuthN + AuthZ + XSUAA"),
        ("m11", "11", "Destinations"),
        ("m12", "12", "External API integration"),
        ("m13", "13", "Events + background jobs"),
    ]),
    ("Agent protocols", [
        ("m14", "14", "MCP from zero"),
        ("m15", "15", "Our MCP server"),
        ("m16", "16", "MCP security"),
        ("m17", "17", "AI agent + tool loop"),
        ("m18", "18", "A2A + discovery"),
        ("m19", "19", "MCP + A2A together"),
        ("m20", "20", "MCP gateway"),
        ("m21", "21", "IAS trust chain"),
    ]),
    ("Experience", [
        ("m22", "22", "SAPUI5 frontend"),
        ("m23", "23", "AI assistant UI"),
        ("m24", "24", "Audit logging"),
        ("m25", "25", "Observability"),
        ("m26", "26", "Error handling"),
    ]),
    ("Ship it", [
        ("m27", "27", "Testing strategy"),
        ("m28", "28", "Postman collection"),
        ("m29", "29", "Migrations+Docker+Git+CI"),
        ("m30", "30", "BTP deploy + security"),
        ("m31", "31", "Prod map + troubleshooting"),
        ("m32", "32", "Source + checklist + matrix"),
    ]),
    ("Audit & full source", [
        ("m33", "33", "Gap audit + Inventory"),
        ("m34", "34", "LLM provider trio"),
        ("m35", "35", "UI5 missing files"),
        ("m36", "36", "Source I: config+deploy"),
        ("m37", "37", "Source II: lib+tests"),
    ]),

]

CONTENT_MODULES = [content_part1, content_part2, content_part3, content_part4, content_part5, content_part6, content_part7, content_part8]

ROADMAP = [
    ("P0", "Architecture map", "A2A+MCP diagram decoded, build-vs-buy split", "done"),
    ("P1", "Project setup", "CAP Node.js project, folder tour", "done"),
    ("P2-P3", "CDS + database", "Domain model, Postgres local, HANA prod", "done"),
    ("P4-P6", "OData + CRUD + logic", "Services, handlers, transactions", "done"),
    ("P7-P10", "Trust + integration", "XSUAA, destinations, external API, events", "done"),
    ("P11-P13", "MCP", "Protocol, server, security", "done"),
    ("P14-P18", "Agents + A2A", "Tool loop, 2 agents, discovery, combined flow", "done"),
    ("P19-P20", "Gateway + IAS", "Gateway responsibilities, trust chain", "done"),
    ("P21-P26", "UI + ops", "UI5, chat UI, audit, observability, errors", "done"),
    ("P27-P35", "Ship", "Tests, Docker, CI/CD, BTP, security, tenancy", "done"),
    ("P36-P41", "Finish", "Architecture poster, checklist, matrix, roadmap", "done"),
    ("P42", "Gap audit + full source", "Inventory pack, /health fix, providers, UI5 files, verbatim repo files", "done"),
]
...
<footer class="site"><div class="wrap">
  <p><strong>Autonomous Procurement Control Tower &mdash; End-to-End SAP CAP + AI Agent + MCP + A2A Hands-On Workshop.</strong> One domain: procurement requisitions to payment. Sources: official CAP docs, npm <code>@cap-js/mcp</code> / <code>@cap-js/agents</code>, modelcontextprotocol.io, a2a-protocol.org, architecture.learning.sap.com (RA0029 &mdash; Agentic AI &amp; AI Agents; A2A + MCP Interoperability). Verify fast-moving SAP service APIs against current SAP documentation.</p>
